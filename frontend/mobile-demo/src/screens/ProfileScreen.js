...
const styles = StyleSheet.create({
  ...
  panelTabTextActive: { color: palette.white },
  heroCard: { padding: 0, overflow: "hidden" },
  heroTop: { minHeight: 108, padding: 17, flexDirection: "row", alignItems: "center", gap: 14 },
  avatarWrap: { width: 74, height: 74, borderRadius: 37, backgroundColor: palette.greenChip, alignItems: "center", justifyContent: "center" },
  avatar: { width: 61, height: 61, borderRadius: 31, backgroundColor: palette.greenBright, alignItems: "center", justifyContent: "center" },
  ...
  syncPill: { borderRadius: 999, borderWidth: 1, borderColor: palette.greenBorder, backgroundColor: palette.greenMist, paddingHorizontal: 8, paddingVertical: 5, flexDirection: "row", alignItems: "center", gap: 5 },
  ...
  heroDivider: { height: 1, marginHorizontal: 17, backgroundColor: palette.borderSoft },
  miniStats: { minHeight: 86, flexDirection: "row", paddingHorizontal: 8, paddingVertical: 12 },
  miniStat: { flex: 1, alignItems: "center", borderRightWidth: 1, borderRightColor: palette.borderSoft, paddingHorizontal: 4 },
  ...
  sparkLine: { width: 34, height: 4, backgroundColor: palette.greenSoft, borderRadius: 999, marginTop: 4, overflow: "hidden" },
  ...
  settingsRow: { minHeight: 58, borderBottomWidth: 1, borderBottomColor: palette.borderSoft, flexDirection: "row", alignItems: "center", gap: 12 },
  noBorder: { borderBottomWidth: 0 },
  rowIcon: { width: 25, alignItems: "center" },
  sourceIcon: { width: 25, height: 25, borderRadius: 13, borderWidth: 1, borderColor: palette.mint, alignItems: "center", justifyContent: "center", backgroundColor: palette.greenMist },
  sourceIconOff: { borderColor: palette.border, backgroundColor: palette.bg },
  rowCopy: { flex: 1 },
  ...
  toggleLabel: { flex: 1 },
  toggleTrack: { width: 43, height: 25, borderRadius: 999, backgroundColor: palette.hairline, padding: 3, justifyContent: "center" },
  toggleTrackOn: { backgroundColor: palette.green },
  toggleThumb: { width: 19, height: 19, borderRadius: 10, backgroundColor: palette.card, shadowColor: palette.black, shadowOpacity: 0.08, shadowRadius: 5 },
  toggleThumbOn: { transform: [{ translateX: 18 }] },
  learnedCard: { borderRadius: 16, borderWidth: 1, borderColor: palette.border, backgroundColor: palette.card, padding: 13, marginTop: 9 },
  ...
  learnedIconRisk: { backgroundColor: palette.redMist },
  ...
  scoreTrack: { flex: 1, height: 8, borderRadius: 999, backgroundColor: palette.borderSoft, overflow: "hidden" },
  scoreFill: { height: "100%", borderRadius: 999 },
  scoreValue: { width: 45, color: palette.dark, fontSize: 10, fontWeight: "900", textAlign: "right" },
  infoBox: { borderRadius: 14, borderWidth: 1, borderColor: palette.greenBorder, backgroundColor: palette.greenMist, padding: 12, marginTop: 10 },
  ...
  clearButton: { minHeight: 45, borderRadius: 14, borderWidth: 1, borderColor: palette.redBorder, backgroundColor: palette.redMist, alignItems: "center", justifyContent: "center", marginTop: 13 },
  clearButtonText: { color: palette.red, fontSize: 12, fontWeight: "900" },
  dangerText: { color: palette.red },
  footerNote: { backgroundColor: palette.greenMist, borderColor: palette.greenBorder, alignItems: "center", justifyContent: "center" },
  footerText: { color: palette.dark, fontSize: 12, lineHeight: 17, fontWeight: "800", textAlign: "center" },
  modalOverlay: { flex: 1, backgroundColor: palette.scrimLight, alignItems: "center", justifyContent: "center", padding: 26 },
  modalCard: { width: "100%", maxWidth: 360, borderRadius: 22, backgroundColor: palette.card, padding: 18, borderWidth: 1, borderColor: palette.border, shadowColor: palette.black, shadowOpacity: 0.18, shadowRadius: 30, shadowOffset: { width: 0, height: 16 } },
  ...
  modalButtonText: { color: palette.white, fontSize: 13, fontWeight: "900" },
